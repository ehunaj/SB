...
#      KICLER ==================
#sl = LineClient()
#sl = LineClient(authToken='EEB1oMXT7BAydWsYCxT8")
#sl = LineClient(id='dsarehun@gmail.com',passwd='ehun4321')
...
#sl = LineClient(id='sarehundoank3@gmail.com',passwd='ehun4321')
#st.log("Auth Token : " + str(st.authToken))

#sv = LineClient()
#sw = LineClient(authToken='ELAJKcyIEnUM
sl = LineClient(id='ehunaj@gmail.com',passwd='ehun4321')
...
#cl = LineClient()
#cl = LineClient(authToken='ELTlU1iznvx46ASP2fF7.B1SXxj/vzd0tDPyYfa16jW.AFPCZk3YYtBklLCIf9YsGO+XUTDY99+IASqB/dOo3s4=')
cl = LineClient(id='ehunaja18@gmail.com',passwd='ehun4321')
#cl.log("Auth Token : " + str(cl.authToken))
#    ASISTEN      =================
#ki = LineClient()
#ki = LineClient(authToken='ELDucV8yBJsmt92L83P1.RNY0mD5hMgMbcfE1tEAyWq.rRzKe0xEWquJssDnlOe32dfy5M63y43a8IW2O6yJIhw=')
ki = LineClient(id='nrsfamil1@gmail.com',passwd='ehun4321')
#ki.log("Auth Token : " + str(ki.authToken))

#kk = LineClient()
#kk = LineClient(authToken='ELOB1YZAkKFLM7lAI0o4.wOkmirNWe41AVCDdjgw/za.bdzkviDt90amJKJRK7aYM1h3uohgz6rZFk3T+SY5wSw=')
kk = LineClient(id='ehun517@gmail.com',passwd='ehun4321')
#kk.log("Auth Token : " + str(kk.authToken))

#kc = LineClient()
#kc = LineClient(authToken='ELEzt25EFJEvD9UIG3Pe.pYxjKbe7w+1iIyyJvihN7G.C4ARRqagkPRWL/WeheqzlIXdGTzdLQkteGkwbmi84Zk=')
