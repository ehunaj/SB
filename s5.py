...
Creator = ["uf0d11974793b860c3d1ef4e593841581","ub3808de9f7df35f57fb366d157f9790a","u0b0e09dce2bd119f794a1adaa977efce"]
admin = ["uf0d11974793b860c3d1ef4e593841581","ub3808de9f7df35f57fb366d157f9790a","u0b0e09dce2bd119f794a1adaa977efce"]
            ...
            if wait["autoAdd"] == True:
                ...
                if(wait["message"]in[""," ","\n",None]):
                   ...
                   #sw.blockContact(op.param1)
                       ...
                       #pass
                   #else:
                       #ehun.sendText(op.param1,str(wait["message1"]))
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    if op.param3 not in wait["blacklist"]:
                                        cl.inviteIntoGroup(op.param1,[kid,lid,mid,Bmid,Cmid,Dmid])
                ...
                if op.param2 not in Bots and op.param2 not in admin:
                    ...
                    for tag in wait["blacklist"]:
                        ...
                        for jj in matched_list:
                            try:
                                random.choice(ABC).kickoutFromGroup(msg.to,[jj])
                                print (msg.to,[jj])
                            except:
                                pass
        ...
        if op.type == 19:
            if Dmid in op.param3:
                if op.param2 in Bots and op.param2 in Creator and op.param2 in admin:
                    ...
                    try:
                        cl.kickoutFromGroup(op.param1,[op.param2])
                        ki.inviteIntoGroup(op.param1,[kid,lid,mid,Bmid,Cmid,Dmid])
                        ehun.acceptGroupInvitation(op.param1)
                        kk.acceptGroupInvitation(op.param1)
                        kc.acceptGroupInvitation(op.param1)
                        cl.acceptGroupInvitation(op.param1)
                        ...
                        try:
                            ki.kickoutFromGroup(op.param1,[op.param2])
                            kk.inviteIntoGroup(op.param1,[kid,lid,mid,Amid,Cmid,Dmid])
                            ehun.acceptGroupInvitation(op.param1)
                        except:
                            try:
                                kk.kickoutFromGroup(op.param1,[op.param2])
       ...
       #--------'----------------#
                              ...
                              if msg._from in admin:
                                  ...
                                  for target in targets:
                                      if target not in Bots:
                                          try:
                                              random.choice(ABC).blockContact(msg.to, [target])
                              ...
                              if msg._from in admin:
                                  ...
                                  for target in targets:
                                      if target not in Bots:
                                          ...
                                          cl.sendMessage(msg.to,"Limit boss ku")
                              else:
                                   cl.sendMessage(msg.to,"Khusus Ehun")
                              ...
                              if msg._from in admin:
                                  url = LineClient()
                                  ehun.sendMessage(msg.to,"line://au/q/" + url)
                                  ehun.sendMessage(msg.to,"Open this link " + url + "\on your LINE forsmartphone in 2 minutes\n" + url)
                                  for s in  url:
                                      ehun.sendMessage(msg.to,"Token mu\n"+s.authToken)
                              else:
                                  ehun.sendMessage(msg.to,"Khusus Admin")
#LineClient())
#ehun.sendQrUrl("line://au/q/" + qrCode.verifier, showQr)
        #server.setHeaders('X-Line-Access', qrCode.verifier)
