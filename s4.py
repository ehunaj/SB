...
#      KICLER ==================
#sl = LineClient()
sl = LineClient(authToken='ELnR0AVfdtUpxTbvy7X7.B1SXxj/vzd0tDPyYfa16jW.hJwJZY96UikB729c8GjNqK4IPsWz++FD/geD9MqDlto=')
#sl = LineClient(id='gmail Line mu',passwd='passwd Line mu')

#sl.log("Auth Token : " + str(sl.authToken))

#st = LineClient()
st = LineClient(authToken='ELjBPRzBO47vCHcCYRg8.9sY37/mZOkHTT1mJDPli2a.GMV8yL8svW+KFX1+BphMjcCEmPAq2HC7iHGe8qk6Mp0=')
#st = LineClient(id='gmail Line mu',passwd='passwd Line mu')
#st.log("Auth Token : " + str(st.authToken))

#sv = LineClient()
sw = LineClient(authToken='ELUagxIN05Taloq7kHF4.BvIR7Jw9VfAdsJzU/uMhba.q1BrD+UX00JCFO3Zr8Y9Hz129OPZSw3gbQRFIk9vk5U=')
#sw = LineClient(id='gmail Line mu',passwd='passwd Line mu')
#sw.log("Auth Token : " + str(sw.authToken))

#    KAPTEN     =================

#cl = LineClient()
cl = LineClient(authToken='ELDOYFWPUAe2kWFbVl31.8nezDhK7HGW9hVtLK4qvGq.MPT9udDZsS9eJTTlvB2Rz7Jh0gWB1f/WWpFJzk0R7ZM=')
#cl = LineClient(id='gmail Line mu',passwd='passwd Line mu')
#cl.log("Auth Token : " + str(cl.authToken))
#    ASISTEN      =================
#ki = LineClient()
ki = LineClient(authToken='EL4VyILgWsYDF91mvpT1.RNY0mD5hMgMbcfE1tEAyWq.KxuNmilKdGMQbt6IIDE+wkYTQs56DbTigskC6MR1jQ0=')
#ki = LineClient(id='gmail Line mu',passwd='passwd Line mu')
#ki.log("Auth Token : " + str(ki.authToken))

#kk = LineClient()
kk = LineClient(authToken='ELVW988GSKrx3PeOg3K4.wOkmirNWe41AVCDdjgw/za.94fgspiLiRvSvxLQxeG9/6qluGmnPTgSMxZWh/rL8x8=')
#kk = LineClient(id='gmail Line mu',passwd='passwd Line mu')
#kk.log("Auth Token : " + str(kk.authToken))

#kc = LineClient()
kc = LineClient(authToken='ELIIqzHWB21Db3vxx1qe.pYxjKbe7w+1iIyyJvihN7G.Ko6lIHrBGz2jnNyU5dBeulGqg0euK+2UoWz5UsoUoWg=')
#kc = LineClient(id='gmail Line mu',passwd='passwd Line mu')
#kc.log("Auth Token : " + str(kc.authToken))

#       INDUK ===========

#ehun = LineClient()
ehun = LineClient(authToken='ELW0STix0s1av31EVWUa.S4cn6FFFnFv+S2Brv+L5cG.QYkjH+i6M80nuZ0tUnmiRlqvHOG7vXnf84k7EdvzgpE=')
#ehun = LineClient(id='gmail Line mu',passwd='passwd Line mu')
            ...
            if Amid in op.param3:
                ...
                for taged in InviterX:
                    if taged in wait['blacklist']:
                        try:
                            ki.cancelGroupInvitation(op.param1,[taged])                           
                            wait['blacklist'][op.param2] = True
                        except:
                            pass
        if op.type == 13:
            if Bmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in wait['blacklist']:
                        try:
                            kk.cancelGroupInvitation(op.param1,[taged])                           
                            wait['blacklist'][op.param2] = True
                        except:
                            pass
        ...
        if op.type == 13:
            if Cmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in wait['blacklist']:
                        try:
                            kc.cancelGroupInvitation(op.param1,[taged])                           
                            wait['blacklist'][op.param2] = True
                        except:
                            pass
                ...
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    try:
                        ...
                        try:
                            ...
                            inv2 = inv1.split(',')
                            for target in inv2:
                                kk.cancelGroupInvitation(op.param1, [target])
                            ...
                            try:
                                ...
                                inv2 = inv1.split(',')
                                for target in inv2:
                                    kc.cancelGroupInvitation(op.param1, [target])
...
#      BLACLIST
        ...
        if op.type == 17 or op.type == 11 or op.type == 13 or op.type == 19 or op.type == 32:
            if op.param2 in wait["blacklist"]:
                pass
            else:
                try:
            ...
            if jid in op.param3:
                if op.param2 in Bots and op.param2 in Creator and op.param2 in admin:
                    ...
                    try:
                        ...
                        kc.inviteIntoGroup(op.param1,[op.param3])
                        cl.cancelGroupInvitation(op.param1,[op.param2])
                        sl.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            kc.kickoutFromGroup(op.param1,[op.param2])
                            cl.inviteIntoGroup(op.param1,[op.param3])
...
#                if sender != cl.profile.mid:
 #                   to = sender
   ...
   #     BELUM SUSUN
                            elif text.lower() == "cumi: ":
                              if msg._from in admin:
                                  proses = text.split(":")
                                  strnum = text.replace(proses[0] + ":","")
                                  num =  int(strnum)
                                  cl.kickoutFromGroup(msg.to, num)
                              ...
                              if msg._from in admin or msg._from in owner:
                                ...
                                try:ehun.inviteIntoGroup(to, [Dmid]);has = "OK"
                                except:has = "NOT"
                                try:ehun.kickoutFromGroup(to, [Dmid]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "🔋██ full 100%"
                                else:sil = "🔌█▒. Low 0%"
                                if has1 == "OK":sil1 = "🔋██ full 100%"
                                else:sil1 = "🔌█▒ Low  0%"
                                ehun.sendMessage(to, "Status:\n\n🔴Kick : {} \n🔴Invite : {}".format(sil1,sil))
