...
#      KICLER ==================
#st = LineClient()
st = LineClient(authToken='ELxvuBo6KOMnfSgl50o8.9sY37/mZOkHTT1mJDPli2a.yXCnZj1XeixZwqRTQfa25nl08pEUzS4COpaf1PL9rv4=')
...
ABC = [cl,ki,kk,kc]
Bots = [kid,lid,mid,Amid,Bmid,Cmid,Dmid]
...
#             PROTECT SC
        if op.type == 11:
            if op.param1 in wait["qr"]:
                try:
                    if ehun.getGroup(op.param1).preventedJoinByTicket == False:
...
#--------------------------------------#
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                st.inviteIntoGroup(op.param1,[op.param3])
                                                ehun.acceptGroupInvitation(op.param1)
                                            except:
                                                pass
        ...
        if op.type == 19:
            if op.param1 in wait["war"]:
                if op.param3 in admin and oo.param3 in Creator:
                    if op.param2 in Bots and op.param2 in Creator and op.param2 in admin:
                        random.choice(ABC).inviteIntoGroup(op.param1,[op.param3])
                        random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                        wait['blacklist']
