...
import youtube_dl
#    KICLER     ==================
sw = LineClient(authToken='ELN1tuwgWXwSoKVQZb94.BvIR7Jw9VfAdsJzU/uMhba.VCBQ3gK84owTse4Mybs6EeSBND59q44TsQ5ngI29X3Y=')
#    KAPTEN     =================
cl = LineClient(authToken='ELGjVe1ouQwK0Fwp2K61.8nezDhK7HGW9hVtLK4qvGq.9KFEcJZ9LHe4y7LVDScTcBYxuQs5c9kD+jZ4K87GzAM=')
#    ASISTEN    =================
ki = LineClient(authToken='ELrKlG0Afhhv84W01uM1.RNY0mD5hMgMbcfE1tEAyWq.kSVGh6v5BLFQCY3szthxgHjoLMnZfEhDAYMBYAiFQQo=')
kk = LineClient(authToken='ELpVkrQ7rlIDUPYoOUC4.wOkmirNWe41AVCDdjgw/za.Q9TTBiuxdwV0oWDt96ngLQ3GkvbVZ7GhWMv+6gm/W9k=')
kc = LineClient(authToken='ELV9ncD3sjF47SEFZKae.pYxjKbe7w+1iIyyJvihN7G.Ot5jJvS7OmB/BzhTNmiBipiGq6jQ0vNIcRyxlwughL4=')
#    INDUK   ===========
ehun = LineClient(authToken='ELqDKEpQ6YJQzV8Y4pea.S4cn6FFFnFv+S2Brv+L5cG.CafBjaqB6EGxI9BYHicV+DLpjjHJNv6Q9VindZx/3pg=')
...
ABF = [cl,ki,kc]
ABG = [cl,ki,kk]
Bots = [lid,mid,Amid,Bmid,Cmid,Dmid]
            ...
            if wait["qr"] == True:
                try:
                    ...
                    try:
                        ...
                        try:
                            G = ki.getGroup(op.param1).preventedJoinByTicket = False
                            if op.param2 not in Bots and op.param2 not in Creator and op.param2 not in admin:
                                Ti = ki.reissueGroupTicket(op.param1)
                                sw.acceptGroupInvitationByTicket(op.param1,Ti)
                                sw.kickoutFromGroup(op.param1,[op.param2])
                            ...
                            try:
                                G = kk.getGroup(op.param1).preventedJoinByTicket = False
                                if op.param2 not in Bots and op.param2 not in Creator and op.param2 not in admin:
                                    Ti = kk.reissueGroupTicket(op.param1)
                                    sw.acceptGroupInvitationByTicket(op.param1,Ti)
                                    sw.kickoutFromGroup(op.param1,[op.param2])
                                ...
                                try:
                                    G = kc.getGroup(op.param1).preventedJoinByTicket = False
                                    if op.param2 not in Bots and op.param2 not in Creator and op.param2 not in admin:
                                        Ti = kc.reissueGroupTicket(op.param1)
                                        sw.acceptGroupInvitationByTicket(op.param1,Ti)
                                        sw.kickoutFromGroup(op.param1,[op.param2])
            ...
            if mid in op.param3:
                ...
                if op.param2 in admin:
                    ...
                    try:
                        ...
                        cl.acceptGroupInvitation(op.param1)
                        random.choice(ABD).kickoutFromGroup(op.param1,[op.param2])
                    except:
                        try:
                            random.choice(ABD).inviteIntoGroup(op.param1,[op.param3])
                            cl.acceptGroupInvitation(op.param1)
                            random.choice(ABD).kickoutFromGroup(op.param1,[op.param2])
                        except:
                            pass
            ...
            if Amid in op.param3:
                ...
                if op.param2 in admin:
                    ...
                    try:
                        ...
                        ki.acceptGroupInvitation(op.param1)
                        random.choice(ABE).kickoutFromGroup(op.param1,[op.param2])
                    except:
                        try:
                            random.choice(ABE).inviteIntoGroup(op.param1,[op.param3])
                            ki.acceptGroupInvitation(op.param1)
                            random.choice(ABE).kickoutFromGroup(op.param1,[op.param2])
                        except:
                            pass
            ...
            if Bmid in op.param3:
                ...
                if op.param2 in admin:
                    ...
                    try:
                        ...
                        kk.acceptGroupInvitation(op.param1)
                        random.choice(ABF).kickoutFromGroup(op.param1,[op.param2])
                    except:
                        try:
                            random.choice(ABF).inviteIntoGroup(op.param1,[op.param3])
                            kk.acceptGroupInvitation(op.param1)
                            random.choice(ABF).kickoutFromGroup(op.param1,[op.param2])
                        except:
                            pass
            ...
            if Cmid in op.param3:
                ...
                if op.param2 in admin:
                    ...
                    try:
                        cl.inviteIntoGroup(op.param1,[op.param3])
                        kc.acceptGroupInvitation(op.param1)
                        random.choice(ABG).kickoutFromGroup(op.param1,[op.param2])
                    except:
                        try:
                            random.choice(ABG).inviteIntoGroup(op.param1,[op.param3])
                            kc.acceptGroupInvitation(op.param1)
                            random.choice(ABG).kickoutFromGroup(op.param1,[op.param2])
                        except:
                            pass
                             ...
                             try:
                                 ...
                                 try:
                                     ...
                                     try:
                                         ...
                                         try:
                                             aws = [mid,Amid,Bmid,Cmid]
                                             ehun.invitIntoGroup(op.param1,aws)
                                             cl.acceptGroupInvitation(op.param1)
                                             ki.acceptGroupInvitation(op.param1)
                                             kk.acceptGroupInvitation(op.param1)
                                             kc.acceptGroupInvitation(op.param1)
